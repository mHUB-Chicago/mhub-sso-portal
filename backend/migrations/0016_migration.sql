...
INSERT INTO "CompanyMembershipType" ("name", "createdAt") VALUES
  ...
  ('Associate Membership - Startup/SME Old',        CURRENT_TIMESTAMP),
...
ALTER TABLE "Company" ADD COLUMN "membershipTypes" TEXT NOT NULL DEFAULT '[]';
UPDATE "Company" SET "membershipTypes" = CASE WHEN "membershipType" IS NULL THEN '[]' ELSE json_array("membershipType") END;
